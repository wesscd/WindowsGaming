...
#
##########
$host.ui.RawUI.WindowTitle = "TechRemote Ultimate Windows Debloater Gaming v.0.2"
...
Function CreateRestorePoint {
  ...
  Checkpoint-Computer -Description "AntesScriptTechRemote" -RestorePointType "MODIFY_SETTINGS"
}
